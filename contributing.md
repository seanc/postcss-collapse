# Contributing to postcss-collapse

First and foremost, thank you! We appreciate that you want to contribute to postcss-collapse, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for postcss-collapse**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for postcss-collapse:

- star the [project](https://github.com/seanc/postcss-collapse)
- tweet your support for postcss-collapse
...
- **version**: please note the version of postcss-collapse are you using
...
[so]: http://stackoverflow.com/questions/tagged/postcss-collapse